...
class HisActionDQNAgent(DQNAgent):
    def __init__(self, model_class, model=None, env=None, exploration=None,
        ...
        saving_dir = '/home/ur5/thesis/simple_task/scoop_grasp_2d/data/history_action_dqn_big'
...
if __name__ == '__main__':
    # agent = HisActionDQNAgent(HistoryActionDQN, model=HistoryActionDQN(), env=ScoopEnv(port=20010),
    #                           exploration=LinearSchedule(100000, initial_p=1.0, final_p=0.1), batch_size=128)
    # agent.train(10000)

    agent = HisActionDQNAgent(HistoryActionDQN)
    agent.load_checkpoint('20181208144614')
